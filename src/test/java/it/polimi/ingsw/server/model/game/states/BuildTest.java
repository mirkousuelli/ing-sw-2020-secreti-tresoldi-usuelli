...
public class BuildTest {
    ...
    @Test
    void blockingTwoOpponentsInOneTurn() throws ParserConfigurationException, SAXException {
        //set game
        Game game = new Game();
        Board board = game.getBoard();
        ...
        Block worker2Player3 = (Block) board.getCell(0, 4);

        Block middleTower1 = (Block) board.getCell(0, 2);
        Block middleTower2 = (Block) board.getCell(2, 0);
        Block bottomTower1 = (Block) board.getCell(1, 2);
        Block bottomTower2 = (Block) board.getCell(2, 1);
        ...
        p3.setCurrentWorker(p3.getWorker(1));
        ...
        bottomTower2.setPreviousLevel(Level.GROUND);
        bottomTower2.setLevel(Level.BOTTOM);

        //set state
        game.setState(State.BUILD);

        game.setRequest(new ActionToPerform<>(p1.nickName, new Demand<>(DemandType.BUILD, new ReducedDemandCell(bottomTower1.getX(), bottomTower1.getY()))));
        GameMemory.save(game, Lobby.BACKUP_PATH);
        ...
        game.setRequest(new ActionToPerform<>(p1.nickName, new Demand<>(DemandType.ADDITIONAL_POWER, new ReducedDemandCell(bottomTower2.getX(), bottomTower2.getY()))));
        GameMemory.save(game, Lobby.BACKUP_PATH);
