...
public class ReturnContent<S> {
     ...
     * @param state the state that the game changed to, after the action are made
     * @param changeTurn tells when the current player changes
     * @param availableGods tells when the list of Gods is available
     */
    ...
    /**
     * Method that tells if the list of Gods is available
     *
     * @return {@code true} if the list of Gods is available, {@code false} otherwise
     */
